String.prototype.trim = function() {
    ...
    function validateUserSelectForm(){
        selectedUsername = document.getElementById("users").value;
	
        if(selectedUsername != "Select User"){
            return true;
        }else{
            document.getElementById("userSelectionMsg").innerHTML="<font color=red>Select a username first</font>";
            return false;
        }
    }
